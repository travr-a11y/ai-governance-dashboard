...
<div class="footer">Frank Advisory · AI Governance Dashboard · Client-side generated · Metadata only (no conversation content)</div>
    ...
    function Module8ReportGenerator({ users, metrics, initiatives, settings, dateRange, hasBehaviorData }) {
    ...
    function App() {
      ...
      useEffect(() => {
        fetch("/dashboard-config.json")
          ...
          .then(j => {
            if (j && (j.SUPABASE_URL || j.SUPABASE_ANON_KEY)) setRuntimeCfg(j);
          })
          .catch(() => {});
      }, []);
      ...
      return React.createElement("div", { style:{ fontFamily:"-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif", background:"#f1f5f9", minHeight:"100vh", padding:24, color:COLOURS.bodyText } },
        ...
        React.createElement("div", { style:{ display:"flex", flexDirection:"column", gap:20 } },
          activeTab === "admin" && (
            supabaseClient
              ? React.createElement(AdminAuthGate, { supabase: supabaseClient, session: authSession },
          ...
          activeTab === "dashboard" && React.createElement(React.Fragment, null,
            ...
            React.createElement(Module8ReportGenerator, { users, metrics, initiatives, settings, dateRange: reportDateRange, hasBehaviorData: hasBehaviorDataForModules }),
        ...
        React.createElement("div", { style:{ textAlign:"center", color:"#9ca3af", fontSize:11, marginTop:24, paddingBottom:12 } }, "Frank Group AI Governance Dashboard · Phase 2 · Optional Supabase persistence; Module 8 optional AI narrative uses your OpenRouter key (aggregated metrics only); all other processing is client-side")
      );
    }
